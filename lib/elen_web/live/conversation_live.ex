defmodule ElenWeb.ConversationLive do
  require Logger

  use Phoenix.LiveView
  use Phoenix.HTML

  alias Elen.{Auth, Chat, Repo}
  alias ElenWeb.ConversationView
  ...
  def handle_params(%{"conversation_id" => conversation_id, "user_id" => user_id}, _uri, socket) do
    ElenWeb.Endpoint.subscribe("conversation_#{conversation_id}")
